        ...
        <div class="container header-container">
            ...
            <nav class="main-nav" id="main-nav" aria-label="Main Navigation">
                ...
                wp_nav_menu(array(
                    ...
                    'container' => false,
                    'menu_class' => 'nav-list',
                    'fallback_cb' => 'my_esport_theme_default_menu',
                ));
                ?>
            </nav>

            <div class="header-actions">
                <button class="action-btn search-btn" id="header-search-toggle"
                    aria-label="<?php esc_attr_e('Search', 'my-esport-theme'); ?>">
            ...
            if (is_user_logged_in()):
                ...
                <div class="account-menu-wrapper" style="position: relative;">
                    <a href="<?php echo esc_url($myaccount_url); ?>" class="action-btn account-btn"
                        aria-label="<?php esc_attr_e('Account', 'my-esport-theme'); ?>">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="account-dropdown">
                        <a
                            href="<?php echo esc_url($myaccount_url); ?>"><?php esc_html_e('My Account', 'my-esport-theme'); ?></a>
            ...
            <?php else: ?>
                <a href="<?php echo esc_url($myaccount_url); ?>" class="action-btn account-btn"
                    ...
                    <span class="account-text"><?php esc_html_e('Login', 'my-esport-theme'); ?> <span
                            style="margin: 0 4px; opacity: 0.5;">|</span>
                        <?php esc_html_e('Register', 'my-esport-theme'); ?></span>
                </a>
            <?php endif; ?>
            <a href="<?php echo function_exists('wc_get_cart_url') ? esc_url(wc_get_cart_url()) : '#cart'; ?>"
                class="action-btn cart-btn" aria-label="<?php esc_attr_e('Cart', 'my-esport-theme'); ?>">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round">
