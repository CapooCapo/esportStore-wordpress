        ...
        <div class="container hero-content-container">
            <div class="hero-content">
                ...
                <p class="section-description">
                    <?php esc_html_e('Modern clothing designed for everyday comfort and style.', 'my-esport-theme'); ?>
                </p>
        ...
        <div class="container">
            <div class="collection-inner">
                <div class="collection-content">
                    ...
                    <p class="section-description">
                        <?php esc_html_e('Simple pieces designed to work together across your wardrobe.', 'my-esport-theme'); ?>
                    </p>
                    <div>
                        <a href="#shop"
    ...
    <section id="promotion" class="promotion-section">
        ...
        <div class="container">
            <div class="promotion-content">
                ...
                <p class="section-description">
                    <?php esc_html_e('Discover selected styles at special prices for a limited time.', 'my-esport-theme'); ?>
                </p>
    ...
    <section id="about" class="about-section">
        <div class="container about-inner">
            ...
            <div class="about-content">
                ...
                <p class="section-description">
                    <?php esc_html_e('We create practical and modern clothing designed for everyday wear. Our focus is on high-quality materials and simple designs that fit naturally into your lifestyle.', 'my-esport-theme'); ?>
                </p>
                <div>
    ...
    <section class="newsletter-section">
        <div class="container">
            ...
            <p class="section-description" style="margin: 0 auto 2rem;">
                <?php esc_html_e('Subscribe to receive new collection updates and offers.', 'my-esport-theme'); ?>
            </p>
    ...
    <section class="contact-section">
        <div class="container">
            <div class="contact-content">
                ...
                <p class="section-description">
                    <?php esc_html_e('Have questions about our products or your order? We are here to help.', 'my-esport-theme'); ?>
                </p>
